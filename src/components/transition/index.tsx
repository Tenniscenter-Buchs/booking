        ...
        <SvgLines animate={true} fade={true} timing={"ease-in-out"} stagger={15}
            ...
            <svg
                ...
                <path id="E1"
                    ...
                    d="M 80.09,137.30
                    C 80.09,137.30 43.43,137.57 43.43,137.57
                    ...
                    61.26,118.04 84.91,117.87 84.91,117.87M 52.50,100.94" />
                <path id="E2"
                    fill={fillText ? "#1a99d6" : "none"} stroke="#1a99d6" strokeWidth={strokeWidth}
                    d="M 363.34,137.30
                    C 363.34,137.30 326.68,137.57 326.68,137.57
                    ...
                    344.51,118.04 368.16,117.87 368.16,117.87" />
                <path id="E3"
                    fill={fillText ? "#1a99d6" : "none"} stroke="#1a99d6" strokeWidth={strokeWidth}
                    d="M 514.43,137.49
                    C 514.43,137.49 477.78,137.75 477.78,137.75
                    ...
                    495.60,118.23 519.25,118.05 519.25,118.05" />
                <path id="H1"
                    fill={fillText ? "#1a99d6" : "none"} stroke="#1a99d6" strokeWidth={strokeWidth}
                    d="M 439.18,160.55
                ...
                <path id="T2"
                    ...
                    465.50,88.62 480.50,88.00 480.50,88.00
                    480.50,88.00 484.75,68.38 484.75,68.38
                    484.75,68.38 472.12,68.00 472.12,68.00
                ...
                <path id="U1"
                    fill={fillText ? "#1a99d6" : "none"} stroke="#1a99d6" strokeWidth={strokeWidth}
                    d="M 365.91,159.91
                    C 365.91,159.91 344.36,159.82 344.36,159.82
                    344.36,159.82 331.64,212.73 331.64,212.73
                    331.64,212.73 327.73,212.73 327.73,212.73
                    327.73,212.73 341.55,160.00 341.55,160.00
                    341.55,160.00 320.09,160.55 320.09,160.55
                    320.09,160.55 305.18,217.64 305.18,217.64
